<div role="status" id="toaster" x-data="toasterHub(@js($toasts), @js($config))" @class([
    'fixed z-50 p-4 w-screen flex flex-col pointer-events-none sm:p-6',
    ...
    <template x-for="toast in toasts" :key="toast.id">
        <div x-show="toast.isVisible"
             ...
             @class(['relative duration-300 transform transition ease-in-out max-w-xs w-screen pointer-events-auto', 'text-center' => $position->is('center')])
